...
| 3 | [3. n8n uses that URL](03-n8n-uses-ollama.md) | **Use case 1:** workflow chain on `qwen2.5:7b`. **Use case 2:** Assistant `/v1` + sandbox wired; chat Hello on that 7B not required |
