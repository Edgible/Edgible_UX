...
**n8n** runs workflows on a box you own (webhooks, cron, glue between APIs). **Edgible** is the public `https://<app>.<org>.edgible.com` door (outbound 443 only — no port-forward, no mesh VPN). This series does **not** use OpenClaw. The editor is **org**; inbound webhooks use a **second hostname**.
